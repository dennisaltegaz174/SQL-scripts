DROP DATABASE IF EXISTS `dennis_sql_invoicing`;
CREATE DATABASE `dennis_sql_invoicing`; 
USE `dennis_sql_invoicing`;
...
DROP DATABASE IF EXISTS `dennis_sql_store`;
CREATE DATABASE `dennis_sql_store`;
USE `dennis_sql_store`;
...
CREATE TABLE `dennis_sql_store`.`order_item_notes` (
...
DROP DATABASE IF EXISTS `dennis_sql_hr`;
...
DROP DATABASE IF EXISTS `dennis_sql_inventory`;
CREATE DATABASE `dennis_sql_inventory`;
USE `dennis_sql_inventory`;
